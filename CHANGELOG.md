...
- Added **CLK120** detection for invisible or format characters in shipped
  URLs (zero-width space, soft hyphen, BOM, non-breaking space, and related
  copy/paste artifacts from Docs, Slack, Word, and PDFs). These characters
  are usually invisible in spreadsheets but change host and UTM parsing.
