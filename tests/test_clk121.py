...
from creator_link_kit.query_invisible import describe_character, find_invisible_characters
...
class Clk121ValidateTests(unittest.TestCase):
    ...
    def test_zwsp_in_utm_source_is_error(self) -> None:
        ...
        codes = [i.code for i in validate_url(url, self.convention)]
    ...
    def test_soft_hyphen_is_error(self) -> None:
        ...
        issue = next(i for i in validate_url(url, self.convention) if i.code == "CLK121")
    ...
    def test_audit_urls_surfaces_clk121(self) -> None:
        ...
        result = audit_urls([url], self.convention)
